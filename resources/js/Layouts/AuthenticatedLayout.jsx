...
import { AlignJustify, LogOut, MessageSquare } from "lucide-react";
import { ToastContainer } from "react-toastify";
import App from "@/Components/App"; // Import the ChatApp component

export default function Authenticated({ auth, header, children }) {
    const [showingNavigationDropdown, setShowingNavigationDropdown] =
        useState(false);
    const [showChat, setShowChat] = useState(false); // Define showChat state with useState
        ...
        <div className="min-h-screen">
            ...
            <nav className="">
                ...
                >
                    ...
                    {adminRole && (
                        <ResponsiveNavLink href="/admin" className="hover:text-white transition-all cursor-pointer">
                            Admin
                        </ResponsiveNavLink>
                    )}
            ...
            {showChat && (
                <div className="fixed bottom-16 right-4 w-[370px] h-[800px] bg-white border rounded-lg shadow-lg flex flex-col">
                    <div className="flex justify-between items-center p-2 border-b bg-blue-600 text-white rounded-t-lg">
                        <h2 className="text-sm font-semibold">Chat with FitnessBot</h2>
                        <button
