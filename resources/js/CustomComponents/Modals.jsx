...
export const UserPremisionInnerModal = ({
...
export const UploadImageInnerModal = ({ setIsModalTwoOpen, user }) => {
    ...
    return (
        <form className="p-6" onSubmit={(e) => handleImageSubmit(e, user.id)}>
            <h2 className="text-2xl font-bold">Добавяне на Снимка</h2>

            <p className="mt-1 text-sm">
                Изберете снимка от вашия компютър, за да добавите към прогреса
                на потребителя.
            </p>
